package com.example.demoproject.d_circuitbreaker_event;
...
public class CircuitBreakerDemoApplication {
    ...
    public RegistryEventConsumer<CircuitBreaker> myRegistryEventConsumer() {
        ...
        return new RegistryEventConsumer<CircuitBreaker>() {
            ...
            public void onEntryAddedEvent(EntryAddedEvent<CircuitBreaker> entryAddedEvent) {
                ...
                CircuitBreaker.EventPublisher eventPublisher = getEventPublisher(entryAddedEvent);
    ...
    private static CircuitBreaker.EventPublisher getEventPublisher(EntryAddedEvent<CircuitBreaker> entryAddedEvent) {
